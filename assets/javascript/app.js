let questions = [
    ...
    },
    {
        ...
        answers: ["Confucius", "Plato", "Jesus", "Solomon"],
        correctAnswer: "Solomon"
    },
    {
        question: "The Creoles of today's New Orleans are descended from whom?",
        answers: ["French Canadians from Nova Scotia", "French and Spanish settlers who lived in the city", "refugees from the Crimean War", "none of the above"],
    ...
    },
    {
        ...
        answers: ["Earl Warren", "Abe Fortas", "Warren Burger", "Clarence Thomas"],
        correctAnswer: "Warren Burger"
    },
    {
        question: "What were the first names of the famous explorers Lewis and Clark?",
        answers: ["Clark and Lewis", "John and Lincoln", "Benjamin and Samuel", "Meriwether and William"],
    ...
    },
    {
        ...
        answers: ["Cuba", "Switzerland", "Vatican City", "Nicaragua"],
    ...
    },
    {
        ...
        answers: ["Cyprus", "Seychelles", "Madagascar", "Sri Lanka"],
    ...
    },
    {
        ...
        answers: ["David Farragut", "John Paul Jones", "George Dewey", "Oliver Hazard Perry"],
        correctAnswer: "John Paul Jones"
    },
    {
        question: "John Brown of Civil War fame was which?",
        answers: ["an abolitionist", "a slave", "a slave-owner", "none of the above"],
    ...
    },
    {
        ...
        answers: ["20,000", "200,000", "2,000,000", "20,000,000"],
    ...
    },
    {
        ...
        answers: ["Buffalo Bill Cody", "Matt Dillon", "Wild Bill Hickok", "Bat Masterson"],
        correctAnswer: "Wild Bill Hickok"
    },
    {
        question: "In what year did Wyatt Earp die?",
        answers: ["1879", "1889", "1909", "1929"],
        correctAnswer: "1929"
    },
    {
        question: "In what year did Leonard Kristensen of Norway lead the first party to land on the mainland of Antarctica?",
        answers: ["1795", "1845", "1895", "1945"],
        correctAnswer: "1895"
    },
    {
        question: "Three of the four following events took place in 1985, which one happened in 1982?",
        answers: ["Mikhail Gorbachev became the leader of the Soviet Union", "Pete Rose broke Ty Cobb's record of 4,191 career hits.", "Coca Cola replaced its formula to create a \"new\" Coke.", "Britain and Argentina fought a war over the Falkland Islands."],
    ...
    },
    {
        ...
        answers: ["Germany", "Great Britain", "The Netherlands", "Portugal"],
